...
class _HomePageState extends State<HomePage> {
    ...
    return Scaffold(
      ...
      drawer: Drawer(
        ...
        child: BackdropFilter(
          ...
          child: Container(
            color: Color.fromARGB(219, 51, 49, 49).withOpacity(0.4), // Set a semi-transparent background color
            child: ListView(
              ...
              children: [
                Container(
                  decoration: BoxDecoration(
                    color: Color.fromARGB(230, 50, 58, 63),
                    borderRadius: BorderRadius.circular(15),
                    boxShadow: [
                      BoxShadow(
                        color: Color.fromARGB(238, 232, 232, 232).withOpacity(0.3),
                        spreadRadius: 1,
                        blurRadius: 5,
                  ...
                  child: ClipRRect(
                    ...
                    child: BackdropFilter(
                      ...
                      child: Container(
                        ...
                        constraints: BoxConstraints(maxWidth: 350), // Set max width
                        child: Column(
                          children: [
                            Text(
                              'Total Balance',
                  ...
                  children: [
                    SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor: Color.fromARGB(238, 107, 81, 153),
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor: Color.fromARGB(230, 46, 15, 100),
                          shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(10),
                          ),
                        ),
                                ...
                                Row(
                                  children: [
                                    Container(
                                      width: 16,
                                      height: 16,
                                      color: Color.fromARGB(230, 107, 81, 153), // Color for Income
                                    ),
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor: Color.fromARGB(230, 84, 36, 165),
                          shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(10),
                          ),
                        ),
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor: Color.fromARGB(230, 107, 81, 153),
                          shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(10),
                          ),
                        ),
  ...
  List<PieChartSectionData> _getSections() {
    ...
    return [
      PieChartSectionData(
        color: Color.fromARGB(230, 84, 36, 165),
        value: income,
      ...
      PieChartSectionData(
        color: Color.fromARGB(230, 46, 15, 100),
        value: expense,
