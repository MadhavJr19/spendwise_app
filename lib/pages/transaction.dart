        ...
        child: Padding(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              Icon leadingIcon;
              if (type == 'Income') {
                cardColor = Color.fromARGB(221, 99, 53, 177); // Darker color for income
                leadingIcon = Icon(Icons.add, color: Colors.white); // + icon for income

              } else if (type == 'Expense') {
                cardColor = Color.fromARGB(230, 46, 15, 100); // Light red for expense
                leadingIcon = Icon(Icons.remove, color: Colors.white); // - icon for expense
              } else {
                cardColor = Colors.grey.shade300; // Default color
                leadingIcon = Icon(Icons.help, color: Colors.white); // Default icon
              }
