...
class ProfilePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Sample user data
    final String userName = "DARTERS";  // Replace with actual user data
    final String userEmail = "Ardra Siva Prasad\nRejeena J Jajin\nEvaniya Anna Suvi";
    final String profilePictureAsset = 'assets/images/team.jpg';  // Path to your local image asset
